<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight">Edit Buku</h2>
    </x-slot>
            ...
            <form action="{{ route('books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl_terbit" value="{{ old('tgl_terbit', $book->tgl_terbit) }}" required
                            class="w-full px-4 py-2 border rounded">
                    </div>
                    ...
                    <div>
                        ...
                        @if ($book->image)
                            <img src="{{ asset('storage/' . $book->image) }}" class="h-20 mb-2 rounded">
                        @else
                    ...
                    <div>
                        <label class="block font-medium text-gray-700 mb-1">File PDF Saat Ini</label>
                        @if ($book->file)
                ...
                <div class="mt-4">
                    ...
                    <textarea name="description" rows="4"
                        class="w-full px-4 py-2 border rounded">{{ old('description', $book->description) }}</textarea>
                </div>
