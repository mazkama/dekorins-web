            ...
            <table id="datatable" class="min-w-full text-sm text-gray-700 pt-4">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 border">Nama Metode</th>
                        <th class="px-6 py-3 border">No. Rekening</th>
                        <th class="px-6 py-3 border">Deskripsi</th>
                ...
                <tbody>
                    @foreach ($methods as $method)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-3 border">{{ $method->name }}</td>
                            <td class="px-6 py-3 border">{{ $method->account_number ?? '-' }}</td>
                            <td class="px-6 py-3 border">{{ $method->description ?? '-' }}</td>
