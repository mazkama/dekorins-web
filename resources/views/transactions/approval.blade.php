        ...
        <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-300">
            <table id="datatable" class="w-full text-sm text-center border border-gray-300 rounded-lg overflow-hidden">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        <th class="px-4 py-3 font-semibold border-b w-12">No</th>
                            ...
                            <td class="px-4 py-2">
                                <div class="flex justify-center gap-3">
                                    <form action="{{ route('transactions.approve', $trx->id) }}" method="POST">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                            class="px-4 py-1.5 bg-green-500 text-white text-sm font-semibold rounded hover:bg-green-600 transition">
                                            Setujui
                                        </button>
                                    </form>
